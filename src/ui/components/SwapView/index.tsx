...
import { SwapPlan } from '@buf/penumbra-zone_penumbra.bufbuild_es/penumbra/core/dex/v1alpha1/dex_pb'
...
export const SwapView: React.FC<{ view: SwapPlan }> = ({ view }) => {
	...
	const {
		...
		const feeAmount = view.swapPlaintext.claimFee.amount
		const {
