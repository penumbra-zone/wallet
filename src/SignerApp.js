...
export class SignerApp {
  ...
  newMessage(data, origin) {
    ...
    const message = observable.object({
      id: uuidv4(), //Идентификатор, используюю uuid, но подошел бы и число с автоинкрементом
    ...
    return new Promise((resolve, reject) => {
      reaction(
        ...
        (status, reaction) => {
          // второй аргумент это ссылка на сам reaction, чтобы его можно было уничтожть внутри вызова
          switch (status) {
            case 'signed':
